          ...
          <View style={[styles.modalOverlay, { backgroundColor: 'rgba(0,0,0,0.5)' }]}>
            <View style={[styles.deliveryModal, { backgroundColor: cardBgColor }]}>
              ...
              <View style={styles.deliveryOptions}>
                <TouchableOpacity
                  style={[styles.deliveryOption, { backgroundColor: cardBgColor, borderColor }]}
                  onPress={() => handleDeliverySelection('pickup')}
                >
                  <MaterialIcons name="local-shipping" size={32} color={colorPalette.primary} />
                  <ThemedText type="subtitle" style={[styles.deliveryOptionTitle, { color: textColor }]}>
                    Pick Up Service
                  </ThemedText>
                  <ThemedText style={[styles.deliveryOptionDesc, { color: subtitleColor }]}>
                    We'll collect your laundry from your location
                  </ThemedText>
                </TouchableOpacity>
